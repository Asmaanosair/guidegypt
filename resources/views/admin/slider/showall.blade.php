            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{url('/KT_Admin/slider/Create')}}" type="button" class="btn btn-success btn-sm pull-right" style="float: right;">Add Image</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        @foreach($department as $row)
                            <tr>
                                ...
                                <td><a href="{{url('/KT_Admin/slider/Edit/'.$row->id)}}" type="button" class="btn btn-success btn-sm "><i class="fa fa-edit"></i></a></td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-danger">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <a type="button" href="{{url('/KT_Admin/slider/Delete/'.$row->id)}}" class="btn btn-outline-light">Delete </a>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        </div>
